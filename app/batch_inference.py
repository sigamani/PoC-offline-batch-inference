...
def batch_inference(model, tokenizer, prompts: List[str], max_new_tokens: int = 100) -> List[Dict]:
    """
    ...
    for i, prompt in enumerate(prompts):
        ...
        print(f"Generated {len(tokenizer.encode(generated_text))} tokens in {inference_time:.2f}s")
...
def main():
    ...
    for i, result in enumerate(results):
        ...
        print(f"Tokens/sec: {result['tokens_generated']/result['inference_time']:.1f}")
