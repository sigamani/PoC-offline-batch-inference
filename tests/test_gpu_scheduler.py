...
class TestMockGPUScheduler:
    ...
    def test_priority_queue_ordering(self):
        ...
        result1 = self.scheduler.allocate_gpu("normal_job", priority_level=priorityLevels.LOW)
        assert result1.queue_position == 1
        
        result2 = self.scheduler.allocate_gpu("priority_job", priority_level=priorityLevels.HIGH)
...
class TestStressScenarios:
    ...
    def test_burst_load(self):
        ...
        for i in range(10):
            ...
            result = self.scheduler.allocate_gpu(job_id, priority_level=priorityLevels.LOW)
    ...
    def test_mixed_priority_load(self):
        ...
        for i in range(8):
            if i % 3 == 0:
                ...
                result = self.scheduler.allocate_gpu(job_id, priority_level=priorityLevels.HIGH)
